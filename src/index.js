...
// Function para borrar la lista
const remove = () => {
    list.innerHTML = "";
};

// Listener para esccuhar el usuario
search.addEventListener(
    "input",
     _.debounce((e) => {
        ...
        fetchCountry(url).then((countries) => {
...
function countrytarget(countries) {
    ...
    list.innerHTML = `
        <div class="country__target" >
            <h1><img  alt="${country.name}" src="${country.flags.svg}">  ${country.name}</h1>
            <ul>
